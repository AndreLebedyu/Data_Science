...
| [Прогнозирование количества заказов такси](Прогнозирование%20количества%20заказов%20такси) | Модель машинного обучения для прогнозирования спроса на такси на следующий час | `CatBoost` `Pandas` `Sklearn` `Statsmodels` `Matplotlib` | `Time Series` `ML`|
