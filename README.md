...
| [Классификация текстовых комментариев](Классификация%20текстовых%20комментариев) | Классификация текстовых комментариев на позитивные и негативные | `CatBoost` `Pandas` `Sklearn`  `NLTK` `Matplotlib` | `ML`<br>`NLP` |
